<!-- NAV STARTS HERE -->
        <nav class="navbar navbar-expand-lg fixed-top">
            ...
            <!-- .weatherButton -->
            <button class="navbar-toggler weatherButton" type="button" data-toggle="collapse" data-target="#navbarWeather" aria-controls="navbarWeather" aria-expanded="false" aria-label="Toggle navigation">
